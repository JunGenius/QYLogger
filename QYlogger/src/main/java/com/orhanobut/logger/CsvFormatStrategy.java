...
//        builder.append(tag);
    ...
    public static final class Builder {
        ...
        @NonNull
        public Builder Path(@Nullable String val) {
            path = val;
            return this;
        }
        @NonNull
...
//                String folder = diskPath + File.separatorChar + "logger_" + dateStr;
//                String folderName = "logger_" + dateStr;

                String folder;
                if (path == null) {
                    folder = diskPath + File.separatorChar + "logger";
                } else {
                    folder = diskPath + File.separatorChar + path;
                }

                HandlerThread ht = new HandlerThread("AndroidFileLogger." + folder);
                ht.start();
                Handler handler = new DiskLogStrategy.WriteHandler(ht.getLooper(), folder, MAX_BYTES , level);
